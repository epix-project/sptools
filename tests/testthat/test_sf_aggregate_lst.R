...
test_that("`sf_aggregate_lst` returns the correct output", {
  ...
  expect_equal(match_pattern(as.data.frame(test1a), "province",
                             kh_province_year),
               "1997-2013")

  test1b <- sf_aggregate_lst(sf1, kh_history, from = "1995-01-01")
  expect_equal(match_pattern(as.data.frame(test1b), "province",
                             kh_province_year),
               "1994-1997")
  ...
  expect_equal(match_pattern(as.data.frame(test2a), "province",
                             la_province_year),
               "2006-2013")

  test2b <- sf_aggregate_lst(sf2, la_history, from = "1998-01-01")
  expect_equal(match_pattern(as.data.frame(test2b), "province",
                             la_province_year),
               "1997-2006")
  ...
  expect_equal(match_pattern(as.data.frame(test3), "province",
                             th_province_year),
               "1977-1981")
})
